...
const MissionEdit = () => {
  ...
  const fetchMission = async () => {
    try {
      ...
      setFormData({
        ...
        image: mission.image || '',
        total_points: mission.total_points || 0,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await missionApi.update(id, submitData);
      navigate('/missions', { state: { message: 'Mission updated successfully!' } });
  ...
  if (loading || tasksLoading) {
    return <div className="text-center mt-3">Loading mission details...</div>;
  }
  ...
  return (
    <div className="mission-edit">
      ...
      <p>Modify mission details and task assignments below.</p>
