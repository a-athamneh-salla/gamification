...
const TaskCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Creating task with data:', formData, eventTypes[formData.event_type]);
      
      const formDataToSend = {
        ...formData,
        event_name: eventTypes[formData.event_type].name || null,
        key: formData.event_type || '',
      };
      await taskApi.create(formDataToSend);
                    ...
                    <div className="card-body">
                      <div className="mb-3">
                        ...
                        >
                          ...
                          {!!eventTypes && !!eventTypes.length ? eventTypes.map(eventType => (
